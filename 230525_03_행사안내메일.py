# 고객의 이름 입력 받기
# 행사 제목 입력 받기
# 행사 날짜 입력 받기 : 날짜를 입력 받아 몇 월인지 확인하고, 그에 맞는 행사 문구 가져와서 출력하기
# 행사 시간 입력 받기 : 시간 입력 받아서 이쁘게 변경하기
...
print(f"{name} 님.")
print(greeting)
print(f"아래의 일정으로 {event}를(을) 진행하고자 하오니 오셔서 자리를 빛내주시기 바랍니다.\n")
print("=" * 5, "행사 안내", "=" * 5)
